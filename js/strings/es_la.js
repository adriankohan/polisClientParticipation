...
s.writePrompt = "Compartir tu perspectiva...";
...
s.helpWhatDoIDo = "Haz clic en 'Acordar' o 'Discrepar' para votar en comentarios ajenos. Escribe un comentario (limítalo a una sola idea). Invita a tus amigos a la discusión!";
s.writeCommentHelpText = "¿Tu perspectiva o experiencias no están representadas en la conversación? Entonces puedes sumarla, <strong>escribiendo</strong> un comentario!";
s.helpWriteListIntro = "¿Qué hace que un comentario sea exitoso?";
s.helpWriteListStandalone = "Que presente una idea única";
s.helpWriteListRaisNew = "Que presente una nueva perspectiva, experiencia o problema";
s.helpWriteListShort = "Qué sea cclaro y conciso (límite - 140 carácteres)";
...
s.commentSendFailed = "Hubo un error procesando tu comentario.";
s.commentSendFailedEmpty = "Hubo un error procesando tu comentario - Comentario incompleto.";
s.commentSendFailedTooLong = "Hubo un error procesando tu comentario - Comentario es demasiado largo.";
s.commentSendFailedDuplicate = "Hubo un error procesando tu comentario. Este comentario ya existe.";
...
s.commentIsTooLong = "Comentario demasiado largo";
s.hereIsNextStatement = "Voto procesado. Navegue arriba para ver el comentario próximo.";
...
s.tipCommentsRandom = "Los comentarios se muestran aleatoriamente. No puedes responder directamente a una persona.";
s.tipOneIdea = "Desagrega los comentarios largos que contienen varias ideas en ideas más pequeñas e independientes. Así será más fácil que los demás voten en su comentario.";
...
s.commentTooLongByChars = "Excediste el límite de caracteres por {{CHARACTERS_COUNT}} caracteres.";
...
s.notificationsAlreadySubscribed = "Estás suscrito para recibir actualizaciones a esta conversación.";
